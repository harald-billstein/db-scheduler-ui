...
public class PrefixedRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
  ...
  private static final String UI_CONTROLLER_PACKAGE_NAME = "no.bekk.dbscheduler.ui.controller";
  private final String prefix;

  public PrefixedRequestMappingHandlerMapping(final String prefix) {
    this.prefix = prefix;
  ...
  protected void registerHandlerMethod(final Object handler, final Method method, final RequestMappingInfo mapping) {
    ...
    if (UI_CONTROLLER_PACKAGE_NAME.equals(packageName)) {
